  ...
  return (
    <div className={` ${styles['container']} ${styles[props.rootClassName]} `}>
      <div className={styles['container01']}>
        <div className={styles['container02']}>
          ...
          <span className={styles['text02']}>
            <span>
              Visit any of our platforms to learn more about our Escape Room
            </span>
            <br></br>
            <span>or to hear from any of our customers.</span>
          </span>
      ...
      <span className={` ${styles['text11']} ${projectStyles['textSM']} `}>
        Copyright Â© 2021 Escape Hilo - Designed By Manner Media LLC.
      </span>
    </div>
  )
}
