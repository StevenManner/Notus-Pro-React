        ...
        <div className={styles['Mid']}>
          <Link to="/profile" className={styles['navlink1']}>
            <div className={styles['container']}>
              ...
              <span
                className={` ${styles['text7']} ${projectStyles['textSM']} `}
              >
                PROFILE
              </span>
            </div>
          ...
          <Link to="/blog-post" className={styles['navlink2']}>
            <div className={styles['container1']}>
              ...
              <span
                className={` ${styles['text8']} ${projectStyles['textSM']} `}
              >
                BLOG
              </span>
            </div>
...
Header.defaultProps = {
  ...
  image_src1: '/playground_assets/escape-hilo-logo-red-300x75-200h.png',
}
